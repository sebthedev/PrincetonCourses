// Adapted from intro.js - https://github.com/usablica/intro.js

// KARA: adapted from http://www.hongkiat.com/blog/introjs-step-by-step-guide-tutorial/
function conductInitialDemo() {
  ...
  introguide.setOptions({
    steps: [
      ...
      {
          element: '#searchbox',
          intro: 'Try searching for a specific course, professor, or distribution requirement!',
          position: 'bottom'
      },
      {
      ...
      {
          element: '#demo-toggle',
          intro: 'Missed anything in the demo? Feel free to revisit it anytime!',
          position: 'bottom'
      }
    ]
  });
